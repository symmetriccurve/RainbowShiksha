...
import SMVMWebsiteLaunchImage from "../assets/past-events/SMVM Website Launch.jpeg";
...
const Events: React.FC = () => {
  ...
  const upcomingEvents = [
    ...
    },
    {
      ...
      type: "support",
      description:
        "At the special request of Sri Madhava School management, our skilled IT team is diligently working on creating a professional, user-friendly website. This digital platform will provide parents, students, and visitors with convenient access to all essential school information, enhancing communication and engagement within the educational community.",
      image:
  ...
  const pastEvents = [
    {
      ...
      type: "support",
      description:
        "As part of Rainbow Shiksha's Digital Initiative program, our skilled IT team developed a professional website for Sri Madhava Vidya Mandira School and successfully launched it on 1st August 2026. This digital platform provides parents, students, and visitors with convenient access to all essential school information, enhancing communication and engagement within the educational community.",
      image: SMVMWebsiteLaunchImage,
      attendees: 10,
      outcome:
        "Successfully developed and launched a professional website for SMVM School",
    },
    {
      id: 10,
      ...
      type: "support",
      description:
        "Paid ₹20,000 towards the 1st Term school fee for student K. Mounika, who is studying in Class 10 at Roots Kiddy's Global School, Adoni Mandal, Kurnool District. We are happy to have supported K. Mounika by paying her Term 1 fee, helping her continue her journey towards a brighter tomorrow.",
    ...
    },
    {
      ...
      type: "support",
      description:
        "Paid ₹20,000 towards the 1st Year, 2nd Term tuition fee for student Shaik Sameera, who is pursuing B.Sc. Nursing at Bollineni College of Nursing, Nellore. Rainbow Shiksha is proud to have supported Shaik Sameera in paying her college fee, helping her continue her journey towards a brighter tomorrow.",
      image: ShaikSameeraFeeImage,
      attendees: 1,
      outcome:
        "Paid ₹20,000 tuition fee for Shaik Sameera's B.Sc. Nursing 1st Year, 2nd Term",
    },
    {
      id: 1,
    ...
    },
    {
      ...
      type: "program",
      description:
        "Our team conducted an engaging games and activities program for children at an orphanage in Lingampally, Hyderabad. Through interactive games, storytelling sessions, and creative workshops, we fostered teamwork, creativity, and joy among the children while providing them with memorable experiences.",
    ...
    },
    {
      id: 4,
      title:
        "3 Computers & 2 Laptops Distribution to Sri Madhava Vidya Mandira School",
      date: "2024",
      location: "Sri Madhava Vidya Mandira School",
      type: "support",
      description:
        "Our team distributed 3 computers and 2 laptops to Sri Madhava Vidya Mandira School to enhance the digital learning infrastructure and provide students with better access to technology for their educational needs.",
      image: LaptopDistributionImage,
      attendees: 100,
      outcome:
        "Distributed 3 computers and 2 laptops to enhance digital learning infrastructure",
    },
    {
      id: 5,
      ...
      type: "support",
      description:
        "We distributed essential exam kits to students at Sri Madhava Vidya Mandira School, providing them with necessary stationery and materials to support their academic examinations and ensure they have the tools needed for success.",
      image: ExamKitEventImage,
      attendees: 100,
      outcome:
        "Distributed exam kits with essential stationery to support student examinations",
    },
    {
      id: 6,
      ...
      type: "program",
      description:
        "We conducted an engaging General Knowledge Quiz designed to enhance students' awareness and broaden their knowledge base. Winners were recognized and awarded prizes, encouraging active participation and fostering greater social awareness among all participants.",
      image: DivyaJyothiEventImage,
      attendees: 50,
      outcome:
        "Conducted GK Quiz and distributed prizes, encouraging social awareness",
    },
    {
      id: 1,
      ...
      type: "program",
      description:
        "We organized a heartwarming Children's Day celebration at an orphanage in Karnataka, bringing joy, laughter, and educational activities to the children. Our team spent quality time with the children, engaging them in creative activities and providing them with essential supplies and gifts.",
      image: ChildrensDayImage,
      attendees: 45,
      outcome:
        "Brought smiles to 45 children and distributed educational materials",
    },
    {
      id: 2,
      ...
      type: "program",
      description:
        "As we got the request from one of the Orphanage located in Karnataka, our team members personally visited the orphanage and distributed books and required stationary to the students.",
      ...
      <section className="bg-gradient-to-br from-blue-50 via-green-50 to-yellow-50 py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 leading-relaxed">
            Join us in our mission to transform education. Participate in our
            events, volunteer your time, or simply come to learn more about our
            cause.
          </p>
        </div>
      </section>
            ...
            <div className="flex flex-wrap gap-2">
              {filterOptions.map((option) => (
                <button
                  ...
                  className={`px-4 py-2 rounded-full text-sm font-medium transition-colors ${activeFilter === option.key
              ...
              >
                <div className="p-6">
                  <div className="flex items-center justify-between mb-3">
                    <span
                      className={`px-3 py-1 rounded-full text-xs font-medium ${event.type === "support"
